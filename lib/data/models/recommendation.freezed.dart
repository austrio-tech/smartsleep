...
abstract class $RecommendationCopyWith<$Res> {
  ...
  @useResult
  $Res call({String category, String message, String priority});
}
...
class _$RecommendationImpl implements _Recommendation {
  ...
  @override
  String toString() {
    return 'Recommendation(category: $category, message: $message, priority: $priority)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, category, message, priority);
